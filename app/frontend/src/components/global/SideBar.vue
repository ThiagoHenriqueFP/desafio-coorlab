<template>
  <nav id="side-bar">
    <img alt="cb logo" src="../../assets/logo.png">
    <div id="calc-field">
      <!-- <img src="../assets/icons/calculator-svgrepo-com.svg" alt="calculator icon" class="smaller"> -->
      ...
      <p class="default-white">Calculadora de Viagem</p>
    </div>
  </nav>
</template>
